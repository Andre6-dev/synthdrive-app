...
CREATE SCHEMA IF NOT EXISTS synthdrive_schema;

SET
    SEARCH_PATH TO synthdrive_schema;

CREATE SEQUENCE IF NOT EXISTS address_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS admin_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS auth_provider_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS booking_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS booking_timeline_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS company_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS customer_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS garage_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS manager_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS review_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS role_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS slot_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS user_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS valet_sequence INCREMENT BY 1;

CREATE SEQUENCE IF NOT EXISTS verification_sequence INCREMENT BY 1;
...
CREATE TABLE admins
(
    id           BIGINT NOT NULL DEFAULT nextval('admin_sequence'),
    created_at   TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    updated_at   TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
...
(
    id      BIGINT NOT NULL DEFAULT nextval('auth_provider_sequence'),
    type    VARCHAR(255),
    user_id BIGINT,
...
(
    id         BIGINT NOT NULL DEFAULT nextval('booking_timeline_sequence'),
...
(
    id           BIGINT NOT NULL DEFAULT nextval('garage_sequence'),
    created_at   TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    updated_at   TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    display_name VARCHAR(255),
    description  VARCHAR(255),
...
(
    id           BIGINT NOT NULL DEFAULT nextval('manager_sequence'),
    created_at   TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    updated_at   TIMESTAMP       DEFAULT CURRENT_TIMESTAMP,
    display_name VARCHAR(255),
    user_id      BIGINT,
...
CREATE TABLE slots
(
    id             BIGINT NOT NULL DEFAULT nextval('slot_sequence'),
    created_at     TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at     TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    display_name   VARCHAR(255),
    price_per_hour DECIMAL,
...
CREATE TABLE valets
(
    id           BIGINT NOT NULL DEFAULT nextval('valet_sequence'),
    created_at   TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at   TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    display_name VARCHAR(255),
...
(
    id         BIGINT  NOT NULL DEFAULT nextval('verification_sequence'),
    created_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
    updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP,
